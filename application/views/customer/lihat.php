								...
								<tbody>
									<?php foreach ($all_customer as $customer): ?>
										<tr>
											...
											<td>
												<a href="<?= base_url('customer/ubah/' . $customer->kode_customer) ?>" class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a>
												<a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('customer/hapus/' . $customer->kode_customer) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php endforeach ?>
								</tbody>
