								...
								<form action="<?= base_url('customer/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="kode_customer" placeholder="Masukkan Kode Customer" autocomplete="off"  class="form-control" required value="C<?= mt_rand(100, 999) ?>" maxlength="8" readonly>
										</div>
										<div class="form-group col-md-6">
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="telp_customer" placeholder="Masukkan No. Telp" autocomplete="off"  class="form-control" required>
										</div>
									</div>
									<hr>
